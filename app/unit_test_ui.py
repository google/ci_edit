...
class UiBasicsTestCases(app.fake_curses_testing.FakeCursesTestCase):
    ...
    def test_save_on_close(self):
        ...
        self.run_with_test_file(kTestFile, [
            ...
            self.write_text(kTestFile), CTRL_J,
            self.display_check(0, 0, [
                u" ci    " + kTestFile[-30:],
                u"            ",
                u"     1 te   ",
    ...
    def test_message_on_text_selection(self):
        self.run_with_test_file(kTestFile, [
            self.cursor_check(2, 7), u'H', u'e', u'l', u'l', u'o',
            self.display_check(2, 0,
                              [u"     1 Hello                            "]),
            self.cursor_check(2, 12), CTRL_A,
    ...
    def test_text_contents(self):
        self.run_with_test_file(kTestFile, [
            self.display_check(2, 7, [u"        "]), u't', u'e', u'x', u't',
