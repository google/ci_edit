...
class CursesUtilTestCases(unittest.TestCase):
  ...
  def test_rendered_sub_str(self):
    ...
    self.assertEqual(u"eight", app.curses_util.renderedSubStr(u"eight", 0, 5))
    ...
    self.assertEqual(u"んにちは",
        app.curses_util.renderedSubStr(u"こんにちは", 2, 10))
    self.assertEqual(u" にちは",
        app.curses_util.renderedSubStr(u"こんにちは", 3, 10))
    self.assertEqual(u"にちは",
        app.curses_util.renderedSubStr(u"こんにちは", 4, 10))
    self.assertEqual(u"は",
        app.curses_util.renderedSubStr(u"こんにちは", 8, 10))
    self.assertEqual(u" ",
        app.curses_util.renderedSubStr(u"こんにちは", 9, 10))
    self.assertEqual(u"",
        app.curses_util.renderedSubStr(u"こんにちは", 10, 10))
    self.assertEqual(u"こんにち ",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 9))
    self.assertEqual(u"こんにち",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 8))
    self.assertEqual(u"こんに ",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 7))
    self.assertEqual(u"こんに",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 6))
    self.assertEqual(u"こん ",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 5))
    self.assertEqual(u"こん",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 4))
    self.assertEqual(u"こ ",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 3))
    self.assertEqual(u"こ",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 2))
    self.assertEqual(u" ",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 1))
    self.assertEqual(u"",
        app.curses_util.renderedSubStr(u"こんにちは", 0, 0))
